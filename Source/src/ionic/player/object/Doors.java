...
public class Doors {
	...
	public static Doors getSingleton() {
		if (singleton == null) {
			singleton = new Doors("./data/doors/singleDoors.txt");
		}
		return singleton;
	}
	...
	// ID X Y FACE0/1/2/3 TYPE0/9 OPEN0/1
	...
	public boolean handleDoor(int id, int x, int y, int z) {
		...
		ObjectHandler.placeObject(new Objects(d.doorId, d.doorX, d.doorY, d.doorZ, getNextFace(d), d.type, 0));
		return true;
	}
