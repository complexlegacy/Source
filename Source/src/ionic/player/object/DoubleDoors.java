...
import ionic.object.customobject.Objects;
...
public class DoubleDoors {
	...
	public static DoubleDoors getSingleton() {
		if (singleton == null) {
			singleton = new DoubleDoors("./data/doors/doubleDoors.txt");
		}
		return singleton;
	}
	...
	public void changeLeftDoor(DoubleDoors d) {
		...
		if (xAdjustment != 0 || yAdjustment != 0) { 
			ObjectHandler.placeObject(new Objects(-1, d.x, d.y, d.z, 0, 0, 0));
		}
		...
		ObjectHandler.placeObject(new Objects(d.doorId, d.x, d.y, d.z, getNextLeftFace(d), 0, 0));
	}
	...
	public void changeRightDoor(DoubleDoors d) {
		...
		ObjectHandler.placeObject(new Objects(d.doorId, d.x, d.y, d.z, getNextRightFace(d), 0, 0));
	}
