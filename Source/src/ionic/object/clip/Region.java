...
public class Region {
	...
	/**
     * Add custom clipped tiles, this is used for the custom objects that are spawned client sided.
     * This clipping only works for following and not walking.
     */
    private static void addCustomClippedTiles()
    {
    	addClipping(3094, 3468, 0, 2097152);
    	addClipping(3095, 3468, 0, 2097152);
    	addClipping(3085, 3476, 0, 2097152);
    	addClipping(1890, 4524, 2, 2097152);
    	addClipping(1891, 4524, 2, 2097152);
    	addClipping(1892, 4524, 2, 2097152);
    	addClipping(2858, 3358, 0, 2097152);
    	addClipping(2857, 3358, 0, 2097152);
    	addClipping(2856, 3358, 0, 2097152);
    	addClipping(2834, 3355, 0, 2097152);
    	addClipping(2831, 3354, 0, 2097152);
    	addClipping(2828, 3356, 0, 2097152);
    	addClipping(2827, 3359, 0, 2097152);
    	addClipping(2824, 3359, 0, 2097152);
    	addClipping(2832, 3349, 0, 2097152);
    }
    
	/**
     * True, if the coordinates is a tile that should be not clipped.
     * <p>
     * This is because these objects have been removed client sided.
     * <p> Note that this only removes the clipping for player following and not manual walking.
     * Do not remove tiles that are beside a wall, because this will enable players to no-clip through the wall.
     * @param x
     * 			The x of the tile.
     * @param y
     * 			The x of the tile.
     ...
     * @return
     * 			True, if the tile matches one of the coordinates in this method.
     */
    private static boolean removeClipping(int x, int y, int height)
    {
    	if (x == 3096 && y == 3469 && height == 0 ||
    		x == 3096 && y == 3470 && height == 0 ||
    	    x == 3091 && y == 3476 && height == 0 ||
    	    x == 3091 && y == 3477 && height == 0 ||
    	  	x == 3091 && y == 3478 && height == 0 ||
    	   	x == 3091 && y == 3479 && height == 0 ||
    	  	x == 3091 && y == 3480 && height == 0 ||
    	   	x == 3092 && y == 3480 && height == 0 ||
    	   	x == 3092 && y == 3477 && height == 0 ||
    	   	x == 3095 && y == 3477 && height == 0 ||
    	   	x == 3095 && y == 3480 && height == 0 ||
    	  	x == 3096 && y == 3480 && height == 0 ||
    	  	x == 3096 && y == 3479 && height == 0 ||
    	   	x == 3096 && y == 3478 && height == 0 ||
    	   	x == 3096 && y == 3477 && height == 0 ||
    	   	x == 3096 && y == 3476 && height == 0 ||
    	    x == 3087 && y == 3469 && height == 0 ||
    	    x == 3086 && y == 3469 && height == 0 ||
    	    x == 3087 && y == 3470 && height == 0 ||
    	    x == 3086 && y == 3470 && height == 0 ||
    	 	x == 3087 && y == 3473 && height == 0 ||
    	  	x == 3086 && y == 3473 && height == 0 ||
    	  	x == 3087 && y == 3474 && height == 0 ||
    		x == 3087 && y == 3473 && height == 0 ||
    	  	x == 3087 && y == 3481 && height == 0 ||
    	   	x == 3087 && y == 3480 && height == 0 ||
    	 	x == 3087 && y == 3475 && height == 0 ||
    	  	x == 3087 && y == 3474 && height == 0 ||
    	  	x == 3086 && y == 3477 && height == 0 ||
    	  	x == 3086 && y == 3475 && height == 0 ||
    	  	x == 3086 && y == 3480 && height == 0 ||
    		x == 3086 && y == 3481 && height == 0 ||
           	x == 2835 && y == 3355 && height == 0 ||
           	x == 2838 && y == 3343 && height == 0 ||
           	x == 2657 && y == 2585 && height == 0 ||
            x == 2656 && y == 2585 && height == 0 ||
            x == 2643 && y == 2592 && height == 0 ||
            x == 2643 && y == 2593 && height == 0 ||
            x == 2670 && y == 2593 && height == 0 ||
            x == 2670 && y == 2592 && height == 0)
        	{
        		return true;
        	}
		return false;
    ...
    public static boolean clippingRemoved(int x, int y, int h) {
    	return removeClipping(x,y,h);
    }
