...
public class Connection {
	...
	**/
	...
	public static void unMuteUser(String name) {
		...
		deleteFromFile("./data/punishment/UsersMuted.txt", name);	
	}
	
	public static void unIPMuteUser(String name) {
		mutedIps.remove(name);
		deleteFromFile("./data/punishment/IpsMuted.txt", name);	
	}
	...
	**/
	public static void removeNameFromBanList(String name) {
		...
		deleteFromFile("./data/punishment/UsersBanned.txt", name);
	}
	...
	**/
	public static void banUsers() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./data/punishment/UsersBanned.txt"));
			String data = null;
			try {
	...
	public static void muteUsers() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./data/punishment/UsersMuted.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					mutedNames.add(data);
	...
	**/
	public static void banIps() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./data/punishment/IpsBanned.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					addIpToBanList(data);
	...
	public static void muteIps() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./data/punishment/IpsMuted.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					mutedIps.add(data);
	...
	**/
	public static void addNameToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./data/punishment/UsersBanned.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
	...
	public static void addUserToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./data/punishment/UsersMuted.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
	...
	**/
	public static void addIpToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./data/punishment/IpsBanned.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
	...
	public static void addIpToMuteFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./data/punishment/IpsMuted.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
